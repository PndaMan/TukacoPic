"""
Django settings for tukaco_pic project.
"""
...
WSGI_APPLICATION = 'tukaco_pic.wsgi.application'
...
if config('USE_SQLITE', default=False, cast=bool):
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='tukaco_pic'),
...
# Add this line to enable WhiteNoise's storage backend
